...
public class ListarCategoria extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lisCategoria.setOnItemClickListener(new ListView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Categoria categoria = (Categoria) lisCategoria
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		case ADD:
			...
			view.findViewById(R.id.btnSalvarCategoria).setOnClickListener(
						...
						public void onClick(View arg0) {
							try {
								...
								if (nome.trim().length() > 0) {
									...
									Toast.makeText(ListarCategoria.this, "Texto invalido!", Toast.LENGTH_LONG).show();
								}
							} catch (Exception e) {
								Toast.makeText(ListarCategoria.this,
	...
	private void loadListView() {
		...
		ArrayAdapter<Categoria> list = new ArrayAdapter<Categoria>(this,
	...
	private final class AnActionModeOfEpicProportions implements
		...
		public boolean onCreateActionMode(ActionMode mode, Menu menu) {
			...
			menu.add(0, DELETE, 0, "Delete").setIcon(R.drawable.abs__ic_clear)
					.setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);

			menu.add(0, UPDATE, 0, "Update").setIcon(R.drawable.ic_update)
					.setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
		...
		public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
			...
			case DELETE:
				...
				builder.setMessage("Deseja remover " + categoria.getNome()
						+ "?");
				builder.setPositiveButton("Manda ver",
			...
			case UPDATE:
				LayoutInflater li = getLayoutInflater();
				final View view = li.inflate(R.layout.add_categoria, null);
				((EditText) view.findViewById(R.id.edtNomeCategoria))
